...
p1 = alex.ptexts.create! history:"#1: Hi! #2: hey there world!", text:"im moving to kansas", number: 6172, image: ""
...
s1 = p1.stexts.create! user: alex, text:"Alex Z needs a place to stay, hes clean and well mannered", image: ""
