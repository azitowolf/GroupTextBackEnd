...
alex = User.create! name:"Alex", avatar:"image", email:"azw@verizon.net", password:"123", password_confirmation:nil
...
p1 = alex.ptexts.create! history:"#1: Hi! #2: hey there world!", text:"im moving to kansas", number: 6172, avatar: ""
...
s1 = p1.stexts.create! user: alex, text:"Alex Z needs a place to stay, hes clean and well mannered", avatar: ""
