...
file = Rack::Test::UploadedFile.new(Rails.root + 'images/geometricBG.jpg', 'image/jpg')

puts file

alex = User.create! name:"Alex", image:"http://www.c4dcafe.com/ipb/uploads/profile/photo-thumb-155544.png", email:"azw@verizon.net", password:"123", password_confirmation:nil, avatar: file
...
# @user_one = User.create!( email: "bkasdhio@gmail.com", username: "blah", password: "password", avatar: @file)
# @user_two = User.create!( email: "crackshaft@gmail.com", username: 'bob', password: "password", avatar: @file)
# @user_two.followers << @user_one

# @file = Rack::Test::UploadedFile.new(Rails.root + 'spec/test.png', 'image/png')
# Picture.create!(caption: "I am user one!", image: file )
